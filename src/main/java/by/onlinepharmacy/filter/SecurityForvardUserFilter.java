...
public class SecurityForvardUserFilter implements Filter {
    private static Logger logger = LogManager.getLogger(SecurityForvardUserFilter.class);
        ...
        HttpSession session = httpServletRequest.getSession();
         UserType type =(UserType)   session.getAttribute("role");
          if ( type != UserType.USER   ) {
              logger.info("SecurityForvardUserFilter redirect to index");
